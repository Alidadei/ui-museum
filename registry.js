...
const EXHIBITS = [
  ...
  },
  {
    ...
    year: "2026",
    origin: "个人创造",
    medium: ["WebGL 流场平流", "Canvas 2D 亮度流场", "加法发光粒子", "像素延展全景", "竖排行楷", "每日一句 JSON"],
    aspect: 16 / 10,
    url: null,
    path: "uis/cosmic-river/",
    live: null,
    source: null,
    note: "策展人注——星河被点亮成活水：把图读成亮度流场后，整幅图沿河道缓缓向下游平流（WebGL 加法平流，周期无缝回卷），河心行人被运动遮罩护住、驻足原地；粒子顺流添光，亮星各自呼吸。桌面宽屏两侧不留黑幕——原图边缘涂抹成余晖、摘来孤立星播种两翼；手机竖屏回归纯竖图。右上竖行楷每日一句，存于 quotes.json 可自行增删，今天轮到的是《兰亭集序》那句——仰观宇宙之大。",
    highlights: [
      { x: 53, y: 49, title: "河心行人", text: "运动遮罩护着这枚剪影驻足原地，任凭星河从脚下流过——动的是河，不是人。" },
