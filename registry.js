...
const EXHIBITS = [
  ...
  },
  {
    ...
    live: null,
    source: null,
    note: "策展人注——星河的动与静各有分寸：光尘顺河漂移、亮星各自呼吸，流线纹理保持全然静止（策展人定版）；河心行人驻足原地，唯独衣袂随风格外轻摆、影子沿主轴缓缓摇曳。桌面宽屏两侧不留黑幕——原图边缘涂抹成余晖、摘来孤立星播种两翼；手机竖屏回归纯竖图。整页可拖动、滚轮/双指缩放、双击复位，走近细看星河。右上竖行楷每日一句，存于 quotes.json 可自行增删，今天轮到的是《兰亭集序》那句——仰观宇宙之大。",
    highlights: [
