...
const EXHIBITS = [
  ...
  },
  {
    ...
    year: "2026",
    origin: "个人创造",
    medium: ["Canvas 2D 亮度流场", "加法发光粒子", "像素延展全景", "竖排行楷", "每日一句 JSON"],
    aspect: 16 / 10,
    url: null,
    path: "uis/cosmic-river/",
    live: null,
    source: null,
    note: "策展人注——一张静止的星河图被原封不动地供起来（原图一分不改），动的是画布上的加法光：启动时把图读成亮度场，梯度一转就是河道，粒子按亮度落进河里，顺着 S 形河势漂向下游，亮星各自呼吸。桌面宽屏时两侧不留黑幕——从原图边缘把余晖涂抹出去、再摘来孤立星播种两翼，塞满整面屏幕；手机竖屏则回归纯竖图。右上竖行楷每日一句，存于 quotes.json 可自行增删，今天轮到的是《兰亭集序》那句——仰观宇宙之大。",
    highlights: [
      { x: 53, y: 49, title: "河心行人", text: "原图中段的小小剪影，一分未动——所有动效都是叠加的加法光，不碰画面本身。" },
