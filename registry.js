...
const EXHIBITS = [
  ...
  },
  {
    ...
    cn: "柒",
    title: "宇宙玄学 · 仰观星河",
    titleEn: "The Cosmic River",
    year: "2026",
    origin: "个人创造",
    medium: ["WebGL 流场平流", "Canvas 2D 亮度流场", "加法发光粒子", "像素延展全景", "竖排行楷", "每日一句 JSON", "整页拖放缩放"],
    aspect: 16 / 10,
    url: null,
    path: "uis/cosmic-river/",
    live: null,
    source: null,
    note: "策展人注——星河被点亮成活水：把图读成亮度流场后，整幅图沿河道缓缓向下游平流（WebGL 加法平流，周期无缝回卷），底部流线、丝缕纹理都在动；河心行人被运动遮罩护住驻足原地，唯独衣袂随风格外轻摆、影子沿主轴缓缓摇曳。桌面宽屏两侧不留黑幕——原图边缘涂抹成余晖、摘来孤立星播种两翼；手机竖屏回归纯竖图。整页可拖动、滚轮/双指缩放、双击复位，走近细看星河。右上竖行楷每日一句，存于 quotes.json 可自行增删，今天轮到的是《兰亭集序》那句——仰观宇宙之大。",
    highlights: [
      { x: 53, y: 49, title: "河心行人", text: "运动遮罩护着这枚剪影驻足原地，唯独衣袂随风格外轻摆、影子沿主轴缓缓摇曳——动的是河，醒着的是人。" },
      { x: 39, y: 15, title: "聚星团的暖色", text: "粒子出生色取自出生地的像素：左上星团出发的光是暖金的，河心的则是冰蓝。" },
      { x: 17, y: 52, title: "延展星域", text: "桌面端两侧不是黑幕：原图边缘的像素被涂抹成余晖，摘来的孤立星逐颗呼吸明灭，塞满全屏。" },
      { x: 93, y: 13, title: "竖排行楷 · 每日一句", text: "每天零点按顺序换一句，句子存于 quotes.json——想让它说什么，自己填。" },
    ],
  },
];
