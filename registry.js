...
const EXHIBITS = [
  ...
  },
  {
    ...
    year: "2026",
    origin: "个人创造",
    medium: ["WebGL 衣袂影子动画", "Canvas 2D 亮度流场", "加法发光粒子", "像素延展全景", "竖排行楷", "每日一句 JSON", "整页拖放缩放"],
    aspect: 16 / 10,
    url: null,
    path: "uis/cosmic-river/",
    live: null,
    source: null,
    note: "策展人注——星河的动与静各有分寸：光尘顺河漂移、亮星各自呼吸；河缘外围的丝线如轻烟般缓缓飘散、明灭呼吸，河核与夜空保持静止，河心行人驻足原地，唯独衣袂随风格外轻摆、影子沿主轴缓缓摇曳。桌面宽屏两侧不留黑幕——原图边缘涂抹成余晖、摘来孤立星播种两翼；手机竖屏回归纯竖图。整页可拖动、滚轮/双指缩放、双击复位，走近细看星河。右上竖行楷每日一句，存于 quotes.json 可自行增删，今天轮到的是《兰亭集序》那句——仰观宇宙之大。",
    highlights: [
