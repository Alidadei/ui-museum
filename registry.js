...
const EXHIBITS = [
  ...
  },
  {
    ...
    year: "2026",
    origin: "个人创造",
    medium: ["Canvas 2D 亮度流场", "加法发光粒子", "竖排行楷", "每日一句 JSON"],
    aspect: 16 / 10,
    url: null,
    path: "uis/cosmic-river/",
    live: null,
    source: null,
    note: "策展人注——一张静止的星河图被原封不动地供起来（原图一分不改），动的是画布上的加法光：启动时把图读成亮度场，梯度一转就是河道，粒子按亮度落进河里，顺着 S 形河势漂向下游，亮星各自呼吸。右上竖行楷每日一句，存于 quotes.json 可自行增删，今天轮到的是《兰亭集序》那句——仰观宇宙之大。",
    highlights: [
